...
*/
select Customers.FullName, Bookings.BookingID from Customers right join Bookings on Customers.CustomerID = Bookings.CustomerID where BookingDate = '2021-11-11';
