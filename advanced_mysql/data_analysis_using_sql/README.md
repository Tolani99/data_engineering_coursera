In a database, a view is a virtual table that does not store data physically. Instead, it is a query-defined table that displays data from one or more tables in the database, or even from other views.
